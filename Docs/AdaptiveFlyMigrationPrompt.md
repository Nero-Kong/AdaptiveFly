...
- The THETA Z1 WebRTC receiver displays an already-stitched equirectangular panorama. RealDrone_Z1 is currently configured for the Z1 top-forward setup with staticMountEulerDegrees = (-90, -90, 0), yawOffsetDegrees = 180, viewerForwardRollDegrees = 90, and Z1 IMU horizon lock disabled. viewerForwardRollDegrees is applied around the HMD/Main Camera forward axis.
